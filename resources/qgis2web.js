...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 16, minZoom: 7, projection: new ol.proj.Projection({
            code: 'EPSG:3067',
            //extent: [266364.900500, 6626338.994083, 475286.228370, 6747956.055807],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([270711.739995, 6611160.400621, 489015.892778, 6792774.779826], map.getSize());
