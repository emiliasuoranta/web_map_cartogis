...
var format_Heatmapforallobservations_3 = new ol.format.GeoJSON();
var features_Heatmapforallobservations_3 = format_Heatmapforallobservations_3.readFeatures(json_Heatmapforallobservations_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3067'});
var jsonSource_Heatmapforallobservations_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Heatmapforallobservations_3.addFeatures(features_Heatmapforallobservations_3);
var lyr_Heatmapforallobservations_3 = new ol.layer.Heatmap({
                declutter: false,
                source:jsonSource_Heatmapforallobservations_3, 
                radius: 10 * 2,
...
lyr_CartoLightAll_0.setVisible(true);lyr_EsriWorldImagery_1.setVisible(true);lyr_Uusimaaborders_2.setVisible(true);lyr_Heatmapforallobservations_3.setVisible(true);lyr_Flyingsquirelobservationsfrom2010to2024_4.setVisible(true);lyr_Names_5.setVisible(true);
var layersList = [lyr_CartoLightAll_0,lyr_EsriWorldImagery_1,lyr_Uusimaaborders_2,lyr_Heatmapforallobservations_3,lyr_Flyingsquirelobservationsfrom2010to2024_4,lyr_Names_5];
